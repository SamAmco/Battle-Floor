...
namespace Battle_Floor
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void Initialize()
        {
            ...
            StorageContainer Container = Device.OpenContainer("SaveStorage");
            FilePath = Path.Combine(Container.Path, "Save.sav");
            Container.Dispose();
            if (File.Exists(FilePath))
            {
                ...
                saveGameData = (SaveGameData)Serializer.Deserialize(fileStream);
                fileStream.Close();
        ...
        private void SaveGame()
        {
            ...
            {
                saveGameData.CurrentLevelTex = (string)("Menu\\Level's\\Level" + enemies.GetLevel() + 1);
                saveGameData.NextLevelTex = (string)("Menu\\Level's\\Level" + (enemies.GetLevel() + 2));
            }
            else
            {
        ...
        {
            if (mainCharacter.CheckGameOver())
            {
